                ...
                >
                    <div className="flex max-w-[1200px] mx-auto">
                        <div className="w-1/2 p-[25px]">
                            <div className=" flex ">
                                ...
                                <div>
                                    ...
                                    <div className="flex text-[12px]">
                                        <div className="me-3">
                                            <p>Kategorie</p>
                                            <p className="bg-white px-[33px] py-[10px] mt-[2px] text-black rounded-md">{category?.name}</p>
                                        </div>
                                        <div>
                                            <p>Use Case</p>
                                            <p className="bg-white px-[33px] py-[10px] mt-[2px] text-black rounded-md">{subCategory?.name}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <p className="py-1 px-10 bg-white w-32 text-black rounded-md mt-3 capitalize">{type}</p>
